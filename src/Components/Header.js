...
export default function Header({ isAuthenticated, setIsAuthenticated }) {
  ...
  return (
    <div className="flex justify-between gap-24 p-5 w-full bg-sky-800 text-white text-xl font-extrabold">
      <p className="3xl:text-4xl pl-8">Attendance</p>
      <div className="flex items-center gap-1 text-base font-bold font-mono 3xl:text-3xl">
